...
if [[ $(hostname) = *fnal* ]]; then
    ...
    sed -e "s#output#${1:-"output"}#" python/metadata/datasets_synthetic_test.yml > $OUTPUT_DIR/datasets_synthetic_test.yml
else
    sed -e "s#\/srv#\/builds\/${CI_PROJECT_PATH}#" python/metadata/datasets_synthetic_test.yml > $OUTPUT_DIR/datasets_synthetic_test.yml
fi
...
# python python/src/scripts/merge_yaml_datasets.py -m python/metadata/datasets_HH4b.yml -f python/skimmer/metadata/picoaod_datasets_declustered_data_test_UL18A.yml  -o python/metadata/datasets_synthetic_seed17_test.yml
...
echo "############### Running test processor "
# python python/src/scripts/merge_yaml_datasets.py -m python/metadata/datasets_HH4b.yml -f python/skimmer/metadata/picoaod_datasets_declustered_test_UL18.yml  -o python/metadata/datasets_synthetic_test.yml
# python python/src/scripts/merge_yaml_datasets.py -m python/metadata/datasets_synthetic_seed17.yml -f python/skimmer/metadata/picoaod_datasets_declustered_GluGluToHHTo4B_cHHH1_Run2_seed17.yml -o python/metadata/datasets_synthetic_seed17.yml
#cat python/metadata/datasets_synthetic_test.yml

time python runner.py -o test_synthetic_datasets.coffea -d synthetic_data synthetic_mc_GluGluToHHTo4B_cHHH1 -p python/analysis/processors/processor_HH4b.py -y UL18  -op $OUTPUT_DIR/ -c python/analysis/metadata/HH4b_synthetic_data.yml -m $OUTPUT_DIR/datasets_synthetic_test.yml

...
if [[ $(hostname) = *fnal* ]]; then
    ...
    ls -lR python/skimmer/
    cat python/skimmer/metadata/picoaod_datasets_TTToHadronic_pseudodata_test_UL18.yml
    echo "TEST"
    pwd
    echo ${CI_PROJECT_PATH}
    sed "s|\/builds/$CI_PROJECT_PATH\/python\/||g"  python/skimmer/metadata/picoaod_datasets_TTToHadronic_pseudodata_test_UL18.yml > ${OUTPUT_DIR}/picoaod_datasets_TTToHadronic_pseudodata_test_UL18.yml
    echo "NEW"
...
# cat python/analysis/metadata/tmp.yml
...
echo "############### Running test processor "
# python python/src/scripts/merge_yaml_datasets.py -m python/metadata/datasets_HH4b.yml -f ${OUTPUT_DIR}/picoaod_datasets_TTToHadronic_pseudodata_test_UL18.yml  -o ${OUTPUT_DIR}/datasets_TT_pseudodata_test.yml
# python python/src/scripts/merge_yaml_datasets.py -m python/metadata/datasets_synthetic_seed17.yml -f ${OUTPUT_DIR}/picoaod_datasets_declustered_GluGluToHHTo4B_cHHH1_Run2_seed17.yml -o ${OUTPUT_DIR}/datasets_synthetic_seed17.yml

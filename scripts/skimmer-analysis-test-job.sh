...
if [[ $(hostname) = *fnal* ]]; then
    ...
    sed -i "s|/builds/${CI_PROJECT_PATH}/||g" $INPUT_DIR/picoaod_datasets_GluGluToHHTo4B_cHHH0_UL18.yml
    cat $INPUT_DIR/picoaod_datasets_GluGluToHHTo4B_cHHH0_UL18.yml
fi
echo "############### Modifying dataset file with skimmer ci output"
python src/scripts/merge_yaml_datasets.py -m $INPUT_DIR/datasets_HH4b.yml -f $INPUT_DIR/picoaod_datasets_GluGluToHHTo4B_cHHH0_UL18.yml -o $OUTPUT_DIR/datasets_HH4b.yml

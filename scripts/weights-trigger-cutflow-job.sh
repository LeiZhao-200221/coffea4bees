...
python coffea4bees/analysis/tests/dumpCutFlow.py --input $INPUT_DIR/test_trigWeight.coffea -o $OUTPUT_DIR/test_dump_cutflow_trigWeight.yml
display_section_header "Running cutflow test"
python coffea4bees/analysis/tests/cutflow_test.py   --inputFile $INPUT_DIR/test_trigWeight.coffea --knownCounts coffea4bees/analysis/tests/known_Counts_trigWeight.yml

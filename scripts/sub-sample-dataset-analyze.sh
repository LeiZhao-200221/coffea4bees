...
echo "############### Running test processor "
# python src/scripts/merge_yaml_datasets.py -m coffea4bees/metadata/datasets_HH4b.yml -f ${OUTPUT_DIR}/picoaod_datasets_TTToHadronic_pseudodata_test_UL18.yml  -o ${OUTPUT_DIR}/datasets_TT_pseudodata_test.yml
# python src/scripts/merge_yaml_datasets.py -m coffea4bees/metadata/datasets_synthetic_seed17.yml -f ${OUTPUT_DIR}/picoaod_datasets_declustered_GluGluToHHTo4B_cHHH1_Run2_seed17.yml -o ${OUTPUT_DIR}/datasets_synthetic_seed17.yml
